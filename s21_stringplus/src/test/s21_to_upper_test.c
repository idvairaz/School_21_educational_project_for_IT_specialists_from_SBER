...
Suite *s21_to_upper_suite(void) {
  ...
  TCase *tcase_core = tcase_create("s21_to_upper");
  tcase_add_test(tcase_core, test_s21_to_upper_1);
  tcase_add_test(tcase_core, test_s21_to_upper_2);
  tcase_add_test(tcase_core, test_s21_to_upper_3);
  tcase_add_test(tcase_core, test_s21_to_upper_4);
