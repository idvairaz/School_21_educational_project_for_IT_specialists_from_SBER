...
Suite *test_s21_is_greater_or_equal(void) {
  ...
  tcase_add_test(tc, test_greater_or_equal_1);
  tcase_add_test(tc, test_greater_or_equal_2);
  tcase_add_test(tc, test_greater_or_equal_3);
  tcase_add_test(tc, test_greater_or_equal_4);
  tcase_add_test(tc, test_greater_or_equal_5);
